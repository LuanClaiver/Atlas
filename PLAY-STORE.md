# Publicar o Atlas na Play Store
...
```bash
keytool -genkeypair -v -keystore atlas-upload.jks -alias smart-life -keyalg RSA -keysize 2048 -validity 10000
```
...
Abra **Actions → Build Play Store AAB → Run workflow**. Ao terminar, baixe o artefato **Atlas v1.2.8 - Play Store**.
