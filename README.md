...
<h1 align="center">Atlas v1.0.7</h1>
...
- Scripts, GitHub Actions, APK/AAB, README e arquivos internos usam a mesma versão **v1.0.7**.
...
3. Baixe o artefato **Atlas-APK-v1.0.7**. Dentro dele estará o arquivo `Atlas-v1.0.7.apk`.
