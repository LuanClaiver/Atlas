<p align="center">
  <img src="docs/images/smart-life-icon.png" alt="Ícone do Atlas" width="150">
</p>

<h1 align="center">Atlas v1.2.8</h1>

## 🆕 Atlas v1.2.8


### Publicação automática no GitHub
- Cada envio da versão para a branch `main` continua gerando o APK pelo GitHub Actions.
- Após o APK terminar com sucesso, o workflow **Publicar versao do Atlas** cria automaticamente a tag `vX.Y.Z` e um **GitHub Release** da mesma versão.
- O APK assinado da versão é anexado ao lançamento automaticamente.
- Se o lançamento já existir, o APK é atualizado sem criar uma versão duplicada.

- **Campo de Batalha:** Missões ganharam visão diária compacta, progresso do dia, categorias, dificuldade, XP e conclusão com tela de recompensa.
- **Trilha de Evolução:** nova área com capítulos, progresso global, etapas concluídas, em andamento e bloqueadas usando os dados reais do Atlas.
- **Academia:** planos de treino, exercícios, séries, repetições, carga, cronômetro, descanso e resumo ao finalizar o treino.
- **Finanças redesenhadas:** orçamento visual, distribuição por categorias, transações recentes e atalhos da **IA Atlas Financeira**.
- **Registro financeiro rápido:** novo modal para lançar receita/despesa de forma compacta e responsiva.
- **Responsividade:** novos módulos foram preparados para celular e computador, reorganizando cards e controles conforme a largura disponível.
- **Infraestrutura preservada:** README, GitHub Actions para APK/AAB, scripts BAT, Supabase e recursos anteriores continuam no pacote.
- Scripts, GitHub Actions, APK/AAB, README e arquivos internos usam a mesma versão **v1.1.6**.
...
<p align="center">
  🟢 Local e privado &nbsp;•&nbsp; 🎮 Gamificado &nbsp;•&nbsp; 📱 Android e computador &nbsp;•&nbsp; 🤖 IA Atlas opcional
</p>
...
O **Atlas** é um organizador pessoal gamificado. Cada hábito e missão concluída gera XP, desenvolve atributos e faz o personagem evoluir de acordo com o nível real do usuário.
...
- **Finanças Atlas integrado:** receitas, despesas, cartões, faturas, empréstimos e recorrências.
- **IA Atlas:** missões, planejamento de metas, organização semanal e revisão semanal com IA Atlas.
- **Backup protegido:** no Android é salvo diretamente em `Downloads`; não inclui chaves da API ou sincronização.


## 📸 Interface atual no celular

Capturas reais da interface atual do Atlas em modo mobile.

<table>
  <tr>
    <td align="center"><strong>Home</strong></td>
    <td align="center"><strong>Level Up</strong></td>
    <td align="center"><strong>Missões</strong></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/atlas-mobile-home.png" alt="Home do Atlas no celular" width="230"></td>
    <td align="center"><img src="docs/images/atlas-mobile-level-up.png" alt="Tela de Level Up do Atlas" width="230"></td>
    <td align="center"><img src="docs/images/atlas-mobile-missions.png" alt="Missões do Atlas no celular" width="230"></td>
  </tr>
  <tr>
    <td align="center"><strong>Menu lateral</strong></td>
    <td align="center"><strong>Academia</strong></td>
    <td align="center"><strong>Atlas responsivo</strong></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/atlas-mobile-menu.png" alt="Menu lateral do Atlas no celular" width="230"></td>
    <td align="center"><img src="docs/images/atlas-mobile-academy.png" alt="Academia do Atlas no celular" width="230"></td>
    <td align="center">Interface adaptada para celular e desktop, mantendo os módulos principais acessíveis.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><img src="docs/images/mobile-apresentacao.png" alt="Tela de apresentação do Atlas no celular" width="280"></td>
    <td align="center"><img src="docs/images/desktop-habitos.png" alt="Tela de hábitos do Atlas no computador" width="760"></td>
  </tr>
</table>

## ⚔️ Evolução visual do personagem

O personagem exibido na aba **Evolução** acompanha o nível real do usuário e segue a progressão completa **E → D → C → B → A → S**.

<table>
  <tr>
    <td align="center" width="33%"><strong>Rank E</strong><br>Níveis 1–10<br><sub>Despertar Inicial</sub></td>
    <td align="center" width="33%"><strong>Rank D</strong><br>Níveis 11–20<br><sub>Ascensão do Caçador</sub></td>
    <td align="center" width="33%"><strong>Rank C</strong><br>Níveis 21–30<br><sub>Sombra em Formação</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/evolution-rank-e.png" alt="Rank E — níveis 1 a 10" width="220"></td>
    <td align="center"><img src="docs/images/evolution-rank-d.png" alt="Rank D — níveis 11 a 20" width="220"></td>
    <td align="center"><img src="docs/images/evolution-rank-c.png" alt="Rank C — níveis 21 a 30" width="220"></td>
  </tr>
  <tr>
    <td align="center" width="33%"><strong>Rank B</strong><br>Níveis 31–40<br><sub>Caçador Rank B</sub></td>
    <td align="center" width="33%"><strong>Rank A</strong><br>Níveis 41–50<br><sub>Ascendente Rank A</sub></td>
    <td align="center" width="33%"><strong>Rank S</strong><br>Nível 51+<br><sub>Monarca das Sombras</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/evolution-rank-b.png" alt="Rank B — níveis 31 a 40" width="220"></td>
    <td align="center"><img src="docs/images/evolution-rank-a.png" alt="Rank A — níveis 41 a 50" width="220"></td>
    <td align="center"><img src="docs/images/evolution-rank-s.png" alt="Rank S — nível 51 em diante" width="220"></td>
  </tr>
</table>
...
Os dados ficam salvos localmente no navegador do dispositivo. Para trocar de computador ou instalar uma versão nova, use o backup do próprio Atlas.
...
3. Baixe o artefato **Atlas-APK-v1.2.8**. Dentro dele estará o arquivo `Atlas-v1.2.8.apk`.
...
- A chave IA Atlas não é incluída no backup.
...
- A geração com IA Atlas agora pede **mais candidatas do que o necessário** e mantém somente as missões realmente diferentes entre si e das missões recentes/abertas.
- O filtro também atua em **Planejar uma Meta**, **Revisão Semanal**, **IA Atlas** e no **Atlas Daily local**.
- Antes de salvar uma sugestão da IA, o Atlas faz uma **segunda verificação**, evitando duplicatas criadas enquanto a tela de revisão estava aberta.
- Chamadas ao IA Atlas agora usam **novas tentativas com espera progressiva** em falhas temporárias e um **modelo Flash-Lite reserva** quando o modelo principal está indisponível.
- Erros de alta demanda do IA Atlas não exibem mais a mensagem técnica em inglês. O Atlas mostra uma explicação curta em português.
...
- **Nova Home “Hoje”** como central do Atlas, com alertas, hábitos, missões, leitura, finanças, foco e resumo semanal.
...
- **Assistente local do Atlas** para perguntas objetivas sobre seus próprios dados; a Central IA Atlas permanece disponível para análises abertas quando configurada.
...
- Backup e restauração continuam disponíveis em JSON, sem incluir credenciais ou a chave IA Atlas.
...
- As notificações Android usam o símbolo próprio do Atlas no lugar do ícone genérico de informação.
...
- O backup continua protegido, sem chave IA Atlas e sem credenciais da sincronização.
...
- Revisão semanal local mostra resultados e também pode usar o IA Atlas com confirmação.
- Notificações Android ganharam ações para concluir ou adiar hábitos, resumo diário e preferências.
- Atlas Online oferece sincronização opcional criptografada via Supabase.
...
- O IA Atlas agora mantém uma conversa real com o IA Atlas.
...
- No celular e no APK, o formulário de login aparece antes da apresentação do Atlas.
...
- A raiz do repositório agora inclui `Iniciar Aplicacao.bat` para abrir o Atlas localmente.
...
- IA Atlas com geração de missões, planejamento de metas, organização semanal e revisão semanal.
- Permissões individuais para perfil, missões, hábitos, projetos e finanças.
- Teste de conexão do IA Atlas e chave protegida nos backups.
