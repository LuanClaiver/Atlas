...
cd /d "%~dp0"
title Atlas - Enviar para GitHub

echo ==============================================
echo       ATLAS v1.0.7 - GITHUB
echo ==============================================
echo.
...
echo.
echo Este pacote ainda nao possui um repositorio GitHub configurado.
set /p "REPO_URL=Cole a URL HTTPS do repositorio do Atlas: "
...
:COMMIT
echo Criando commit Atlas v1.2.6...
git commit -m "Atlas v1.2.6"
if errorlevel 1 goto ERROR
...
echo O GitHub Actions vai gerar o APK e publicar o Release automaticamente.
echo ==============================================
pause
exit /b 0
